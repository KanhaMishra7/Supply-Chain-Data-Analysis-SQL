...
* Analyze supply chain data to identify trends and inefficiencies
* Evaluate customer behavior and purchasing patterns
* Measure revenue performance and supplier contribution
...
This project is part of my portfolio to demonstrate **real-world SQL and data analytics skills** for roles in:
